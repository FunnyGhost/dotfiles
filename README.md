...
- **Editors / dev tools**: Neovim (Lazy.nvim), Git, Claude Code, Codex CLI (with a personal workflows plugin), 21 custom git commands (submodule), [`wwid`](https://github.com/FunnyGhost/wwid) (find & resume Claude Code chats from anywhere — installed via the `funnyghost/tap` Homebrew tap)
